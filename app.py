...
def main():
    ...
    title = '<h1 style="font-family:Arial; color:Black;">Better Information, Better Health</h1>'
    st.markdown(title, unsafe_allow_html=True)
    subheader = '<h3 style="font-family:Arial; color:Black;">Disease Prediction and Drug Recommendation</h3>'
